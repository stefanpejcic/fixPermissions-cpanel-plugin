#! /bin/bash
# 
# License: GNU General Public License v3.0 See the Github page for full license and notes: https://github.com/PeachFlame/cPanel-fixperms
#
# Set verbose to null
verbose=""
#Print the help text
...
fixperms () {
  ...
  #Else, start doing work
    ...
    # Hidden files support: https://serverfault.com/a/156481 fix hidden files and folders like .well-known/ with root or other user perms
